...
const AwsLogo = () => (
    <svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor" className="text-white group-hover:text-[#FF9900] transition-colors duration-300">
        <path d="M11.083 16.155c.394.444.985.444 1.379 0l.298-.334c.789-.887.32-1.55-.444-1.55h-1.48c-.764 0-1.233.663-.453 1.55l.298.334zM.846 11.458c.532-1.39 1.48-1.39 2.012 0l.477 1.25c.532 1.39-.06 2.338-1.506 2.338-.845 0-1.506-.39-1.506-1.163v-1.175c0-.773.66-1.163 1.506-1.163h.017zm13.12 6.556c-1.21 1.055-2.73 1.637-4.22 1.637s-3.01-.582-4.22-1.637c-.328-.285-.515-.705-.515-1.133V13.6c0-1.385 1.408-2.455 3.06-2.455h3.35c1.652 0 3.06 1.07 3.06 2.456v3.28c0 .428-.187.848-.515 1.132zM22.01 5.37c-.227-.375-.59-.625-1.01-.625h-2.12c-.42 0-.782.25-1.008.625l-2.02 3.326c-.226.375-.045.86.33 1.05.375.19.832.044 1.057-.33l1.126-1.854 1.125 1.853c.226.375.682.52 1.057.33.375-.188.556-.673.33-1.05l-2.018-3.325zM12.23 6.945l-2.193 3.61c-.22.36-.04.81.32 1.00s.80.03 1.02-.33l1.34-2.20 1.34 2.20c.22.36.68.51 1.02.33s.54-.64.32-1.00L12.23 6.95zM23.15 11.46c.53-1.39 1.48-1.39 2.01 0l.48 1.25c.53 1.39-.06 2.34-1.5 2.34-.85 0-1.51-.39-1.51-1.16v-1.18c0-.77.66-1.16 1.51-1.16h.02z" />
    </svg>
);
...
export default function CloudPartners() {
  return (
    <section id="partners" className="w-full py-20 lg:py-32 relative">
      <div className="absolute inset-0 -z-10 opacity-30">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-teal-900/50 via-background to-blue-900/50"></div>
        <div className="absolute inset-0 bg-[url('/particles.png')] bg-repeat opacity-10 animate-[pan_30s_linear_infinite]" />
      </div>
